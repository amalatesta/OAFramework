...
{
  public static final String RCS_ID="$Header: AdvTablePageCO.java 120.3 2006/05/25 00:43:12 atgops1 noship $";
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    ...
    else if (pageContext.getParameter("CreateEmp") != null)
    {
      // am.invokeMethod("<someCreateHandler>");
    }
